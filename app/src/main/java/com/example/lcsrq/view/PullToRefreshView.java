...
/**
 * 上拉下拉刷新控件（必须在该线性布局中嵌套listview或gridview或scrollview使用）
 */
public class PullToRefreshView extends LinearLayout {
	...
	private TextView mHeaderTextView;// 表头提示语
	private TextView mFooterTextView;// 表尾提示语
	private RelativeLayout mHeaderProgressBar;// 表头进度条
	private RelativeLayout mFooterProgressBar;// 表尾进度条
	private LayoutInflater mInflater;
	private int mHeaderState;
	private int mFooterState;

	private boolean isFoot = true;// 是否允许上拉加载
	private boolean isHeader = true;// 是否允许下拉刷新
	/**
	...
	private void addHeaderView() {
		...
		mHeaderView = mInflater.inflate(R.layout.xialashuaxin_pull_head, this, false);
	...
	private void addFooterView() {
		...
		mFooterView = mInflater.inflate(R.layout.xialashuaxin_pull_footer, this, false);
