...
//            myOrientationListener.start();
    ...
    private Context context = DingWeiActivity.this;
...
//            mBaiDuMap.setMyLocationConfiguration(configuration);
            ...
            if (isFirstIn) {
                ...
                MapStatusUpdate myselfU = MapStatusUpdateFactory.newLatLngZoom(latLng, 17.0f);
...
//                // 获取经纬度
    ...
    private class MyMapStatusChangeListener implements BaiduMap.OnMapStatusChangeListener {
        ...
        public void onMapStatusChangeFinish(MapStatus mapStatus) {
            ...
            mLongtitude = target.longitude;
            Toast.makeText(DingWeiActivity.this, target.latitude + "" +  target.longitude + "",Toast.LENGTH_SHORT).show();
        }
    }
        //  权限处理
            ...
            Snackbar.make(mMapView, "permission_contacts_rationale", Snackbar.LENGTH_SHORT)
                    .setAction("ok", new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat.requestPermissions(DingWeiActivity.this, PERMISSIONS_CONTACT,
                                    REQUEST_CONTACTS);
                        }
                    })
                    .show();
    ...
    public void onClick(View v) {
        if (v.getId()== R.id.commonLeftBtn){
            Intent intent = new Intent(DingWeiActivity.this, GyzXxwhActivity.class);
            ...
            bundle.putString("long",mLongtitude+"");
            intent.putExtra("bundle",bundle);
            setResult(50,intent);
            finish();
        }
