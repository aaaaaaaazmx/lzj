    ...
    if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
        ...
        factory(window['H'] = {
            ...
            selectTip: function (element, items, okCallback, cancelCallback) {
                ...
                // 默认第一个高亮
                that.cssText(that.D(".H-select-item:nth-child(1)", items), "font-size:1.8rem;color:#52ace5;transition: font-size 0.2s;-webkit-transition: font-size 0.2s;");
                ...
                that.on(options, "touchmove", function (event) {
                    if (event.targetTouches.length == 1) {
                        ...
                        that.cssText(currentItem, "font-size:1.8rem;color:#52ace5;transition: font-size 0.2s;-webkit-transition: font-size 0.2s;");
            ...
            dateTip: function (element, okCallback, cancelCallback) {
                ...
                // 默认第一个高亮
                that.cssText(that.Ds(".H-select-item:nth-child(1)"), "font-size:1.8rem;color:#52ace5;transition: font-size 0.2s;-webkit-transition: font-size 0.2s;");
